...
Today was the first time for me integrating a page done by the frontend team with my work. I created the controller and the view class and took from them the html,css and JavaScript.
